<template>
  <AppLayout>
    ...
    <div class="mb-8">
      ...
      <p class="mt-1 text-sm text-[var(--color-muted-foreground)]">探索 AI 能力，一键生成专属分析报告。新 Skill 持续添加中。</p>
    </div>
    ...
    <StateWrapper
      ...
      :error="error"
      :empty="filteredSkills.length === 0 && !skillStore.loading && !error"
      :empty-description="search ? '没有匹配的 Skill' : '暂无可用 Skill'"
      :retry="fetchSkills"
    >
      <!-- Card grid -->
